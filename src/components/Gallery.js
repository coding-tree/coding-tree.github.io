...
const Gallery = ({ rwd, children }) => {
  ...
  const fakeImages = [
    ...
    {
      id: 2,
      thumb: "/images/mobile/2.jpg",
      src: "/images/2.jpg",
      srcset: "/images/2.jpg 896w",
      alt: ""
    },
    {
      id: 3,
      thumb: "/images/mobile/3.jpg",
      src: "/images/3.jpg",
      srcset: "/images/3.jpg 896w",
      alt: ""
    },
    {
      id: 4,
      thumb: "/images/mobile/4.jpg",
      src: "/images/4.jpg",
      srcset: "/images/4.jpg 896w",
      alt: ""
    }
  ];
  ...
  useEffect(() => {
    !checkDesktop
      ? setImage(false)
      : lightbox && openedImage && lightbox.current.focus();
  ...
  const changeImage = type => {
    ...
    setImage(prevState => {
      if (type === "prev")
        return prevState - 1 === 0 ? fakeImages.length : prevState - 1;
        ...
        <div className="grid-gallery">
          {fakeImages.map(el => (
            <div key={el.id} className="grid-item">
              <img
                onClick={() => checkDesktop && openLightbox(el.id)}
                src={el.thumb}
                alt={el.alt}
              />
            </div>
