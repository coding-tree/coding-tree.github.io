          ...
          <Birds
            placeOne={props => (
              <BirdContainer birdType="baby" bird="baby" title="Baby Bird" {...props}>
                ...
                consectetur rerum doloremque iure. Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum harum
                architecto nulla dicta amet cum quidem voluptatem odio officia veritatis ea distinctio sed, natus vero
                quasi, culpa repudiandae necessitatibus consectetur?
              </BirdContainer>
            )}
            placeTwo={props => (
